...
if (eliza\beta\Response::Kb($Id)->count())
    $Issue = eliza\beta\Response::Kb($Id)->offsetGet(0);
else {
    $Issue = new eliza\beta\Object();
    $Issue->Issue = null;
    $Issue->Type = null;
    $Issue->Description = null;
    $Issue->Tags = array();
    $Issue->Checklist = array();
    $Issue->Related = array();
}
...
<div class="kb edit">
    ...
    <div class="input array">
        <h3>Related</h3>
        <div class="drop">
            <?php foreach ($Issue->Related as $id): $Related = eliza\beta\Response::Kb($id)->offsetGet(0); ?>
